...
export interface GameSettings { ImpostorCount:number; Categories:string[]; HintMode:HintMode; GameMode:OnlineGameMode; TurnSeconds:number; DiscussionSeconds:number; VotingSeconds:number; RoundCount:number; ShowCategoryToImpostor:boolean; AllowImpostorGuess:boolean; LastChanceGuess:boolean }
